...
save_dir = os.path.join('../repo/distill', args.dataset, 'vgg16do', 'session5')
...
model_name = '{}_{}_s5_t{}_d{}_seed{}'.format(args.net, args.dataset, args.temp, args.distill, args.seed)
