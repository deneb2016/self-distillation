...
parser.add_argument('--drop_p', default=0.2, type=float, help='dropout probability (default: 0.0)')
...
save_dir = os.path.join('../repo/distill', args.dataset, 'densenet', 'session11')
...
model_name = '{}_{}_s11_seed{}_d{}_t{}'.format(args.net, args.dataset, args.seed, args.distill, args.temp)
