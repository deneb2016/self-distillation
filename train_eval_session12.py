...
save_dir = os.path.join('../repo/distill', args.dataset, 'vgg16do', 'session12')
...
model_name = '{}_{}_s12_seed{}_wd{}_d{}_t{}'.format(args.net, args.dataset, args.seed, args.wd, args.distill, args.temp)
