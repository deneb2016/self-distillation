...
import numpy as np
import math
from model.vgg_dropconnect import VGGNetDropConnect
...
save_dir = os.path.join('../repo/distill', args.dataset, 'vgg16dc', 'session14')
...
if args.drop_last_only:
    model_name = '{}_{}_s14_dl_dp{}_fd{}_wd{}_seed{}_d{}_t{}'.format(args.net, args.dataset, args.drop_p, args.feat_dim, args.wd, args.seed, args.distill, args.temp)
else:
    model_name = '{}_{}_s14_dp{}_fd{}_wd{}_seed{}_d{}_t{}'.format(args.net, args.dataset, args.drop_p, args.feat_dim, args.wd, args.seed, args.distill, args.temp)
...
if __name__ == '__main__':
    ...
    if args.net == 'vgg16':
        net = VGGNetDropConnect(num_classes, args.drop_p, args.drop_last_only, args.feat_dim)
    else:
